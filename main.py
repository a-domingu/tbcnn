...
def layer_and_SGD_inizialitation(feature_size, alpha):
    ...
    return convolutional_layer, max_pooling_layer, dynamic_pooling, hidden_layer, optimizer
...
#####################################
### Inicializar todos los parametros a optimizar (matrices + bias)
alpha = 0.1
epoch = 10
feature_size = 20
...
train(coding_layer, convolutional_layer, max_pooling_layer, dynamic_pooling, hidden_layer, filepath, feature_size, optimizer, epoch)
